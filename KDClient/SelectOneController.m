...
@implementation SelectOneController

@synthesize delegate, key, rows, selectionTable;


- (void)didCancel:(id)sender {
	NSLog(@"SelectOneController.cancel");
	[self.delegate didCancel:self];
}

- (void)didAccept:(id)sender {
	NSLog(@"SelectOneController.accept");
	[self.delegate didAccept:self];
}
